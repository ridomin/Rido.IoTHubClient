...
using System.Web;
    ...
    public class Command_getMaxMinReportArgs : EventArgs
    {
    ...
    public class Thermostat
    {
        ...
        public event EventHandler<Command_getMaxMinReportArgs>? OngetMaxMinReportCalled = null;
        ...
        async Task Configure()
        {
            ...
            client.UseApplicationMessageReceivedHandler(m =>
            {
                ...
                if (m.ApplicationMessage.Topic.StartsWith("$iothub/twin/PATCH/properties/desired"))
                {
                    ...
                    OntargetTemperatureUpdated?.Invoke(this, new TargetTemperatureArgs { targetTemperature = targetTemperature.GetDouble() });
                }
                ...
                {
                    msg = Encoding.UTF8.GetString(m.ApplicationMessage.Payload ?? Array.Empty<byte>());
                    OngetMaxMinReportCalled?.Invoke(this, new Command_getMaxMinReportArgs { since = JsonSerializer.Deserialize<DateTime>(msg) });
                }    
            });
        }
