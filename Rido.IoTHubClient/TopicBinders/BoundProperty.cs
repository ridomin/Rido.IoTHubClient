...
namespace Rido.IoTHubClient.TopicBinders
{
    public class Bound_Property<T>
    {
        ...
        public Bound_Property(IMqttConnection connection, string name, string component = "")
        {
            propertyName = name;
        ...
        {
            PropertyValue = WritableProperty<T>.InitFromTwin(twin, propertyName, componentName, defaultValue);
