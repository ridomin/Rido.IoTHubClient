...
namespace Rido.IoTHubClient
{
    public static class IMqttClientExtensions
    {
        ...
        public static async Task<MqttClientAuthenticateResult> ConnectV2WithSasAsync(this IMqttClient mqttClient, string hostName, string deviceId, string sasKey, string modelId = "", int minutes = 60)
        {
        ...
        public static async Task<MqttClientAuthenticateResult> ConnectV2WithSasAsync(this IMqttClient mqttClient, string hostName, string deviceId, string moduleId, string sasKey, string modelId = "", int minutes = 60)
        {
            (string username, byte[] password) = SasAuthV2.GenerateHubSasCredentials(hostName, deviceId, moduleId, sasKey, minutes);
            return await mqttClient.ConnectAsync(new MqttClientOptionsBuilder()
